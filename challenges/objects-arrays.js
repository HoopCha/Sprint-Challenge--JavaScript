...
graduates.forEach(graduates => {
  let emailname = graduates.first_name + " " + graduates.email;
  contactInfo.push(emailname)
});
...
lowPopulationAnimals = zooAnimals.filter((zooAnimals) => {
...
populationTotal = zooAnimals.reduce((acc, currentValue) => {
